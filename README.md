...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ks6nxr8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ks6nxr8.containers.anotherwebservice.com/
...
```
git clone git@github.com:GingerNinja1984/container-ks6nxr8.git
cd container-ks6nxr8
```
...
```
docker attach container-ks6nxr8
```
